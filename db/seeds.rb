...
Product.delete_all
Product.create! id: 1, name: "Whisky Etiqueta roja", price: 150.49, active: true, tipoproductos_id: 1
Product.create! id: 2, name: "Appleton", price: 220.29, active: true , tipoproductos_id: 3
Product.create! id: 3, name: "Piqueo 3 sabores", price: 21.99, active: true, tipoproductos_id: 5
Product.create! id: 4, name: "Cerveza Qusqueña", price: 15.99, active: true, tipoproductos_id: 5
Product.create! id: 5, name: "Cerveza Pilsen", price: 15.99, active: true, tipoproductos_id: 5
Product.create! id: 6, name: "Cerveza Heineken", price: 18.99, active: true, tipoproductos_id: 5
Product.create! id: 7, name: "Cerveza Corona", price: 20.99, active: true, tipoproductos_id: 5
Product.create! id: 8, name: "Cerveza Stella Artois", price: 25.99, active: true, tipoproductos_id: 5
Product.create! id: 9, name: "Pizza Grande", price: 39.99, active: true, tipoproductos_id: 6
Product.create! id: 10, name: "Tequeños", price: 19.99, active: true, tipoproductos_id: 1
Product.create! id: 11, name: "Hot Wings", price: 20.99, active: true, tipoproductos_id: 1
Product.create! id: 12, name: "Nachos", price: 14.99, active: true, tipoproductos_id: 1
Product.create! id: 13, name: "Causitas rellenas", price: 19.99, active: true, tipoproductos_id: 2
Product.create! id: 14, name: "Tequeños de lomo saltado", price: 19.99, active: true, tipoproductos_id: 2
